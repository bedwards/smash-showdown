...
local PLUGIN_VERSION = "6.0.0"
local PLUGIN_ID = "FF_DevTools"
...
local CLOUD_ASSETS = {
	FerrisWheel = 110211934243425,
	RadioTower = 118892264593383,
	WaterTower = 74178044492057,
	Lighthouse = 122750640648927,
	AbandonedHouse = 126607046284130,
	Bridge = 95317510532706,
}
...
log("========================================")
log("FF Dev Tools v" .. PLUGIN_VERSION .. " loaded!")
